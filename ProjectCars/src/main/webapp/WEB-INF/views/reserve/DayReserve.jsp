...
<!-- 유효성체크JS -->
<script src="${ctx}/resources/js/rev_valid1day.js"></script>
...
%>
	...
	<form action="onedaypayment.do?price=${vDto.price}" method="post" name="revForm">
    ...
    <div class="container">
        ...
        <div class="form-check">
            ...
            $(function(){
                ...
                $('#datepicker1').datepicker({ dateFormat: 'yy-mm-dd',minDate : 0, maxDate: +60} );
